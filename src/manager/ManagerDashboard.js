...
export default function ManagerDashboard() {
  ...
  useEffect(() => {
    ...
    const fetchDashboardStats = async () => {
      try {
        const res = await axios.get(
          "https://absensi-backend-production-a2fe.up.railway.app/api/dashboard/manager-summary",
          {
    ...
    const fetchAttendanceToday = async () => {
      try {
        const res = await axios.get(
          "https://absensi-backend-production-a2fe.up.railway.app/api/attendance/manager/today",
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        );
    ...
    const fetchRecentRequests = async () => {
      try {
        const res = await axios.get(
          "https://absensi-backend-production-a2fe.up.railway.app/api/dashboard/recent-requests",
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        );
