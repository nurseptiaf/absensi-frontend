...
export default function KelolaReimbursement() {
  ...
  const fetchReimbursements = async () => {
    try {
      ...
      const res = await fetch("https://absensi-backend-production-a2fe.up.railway.app/api/reimbursement/all", {
        headers: {
  ...
  const updateStatus = async (id, newStatus) => {
    try {
      ...
      const endpoint =
        newStatus === "approve"
          ? `https://absensi-backend-production-a2fe.up.railway.app/api/reimbursement/approve/${id}`
          : `hhttps://absensi-backend-production-a2fe.up.railway.app/reimbursement/reject/${id}`;
