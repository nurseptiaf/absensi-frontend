...
export default function KelolaLeave() {
  ...
  const fetchLeaves = async () => {
    try {
      const res = await fetch("https://absensi-backend-production-a2fe.up.railway.app/api/leave/all", {
        headers: {
  ...
  const approveLeave = async (id) => {
    try {
      const res = await fetch(`https://absensi-backend-production-a2fe.up.railway.app/api/leave/approve/${id}`, {
        method: "PUT",
        headers: {
  ...
  const rejectLeave = async (id) => {
    try {
      const res = await fetch(`https://absensi-backend-production-a2fe.up.railway.app/api/leave/reject/${id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${localStorage.getItem("token")}`,
